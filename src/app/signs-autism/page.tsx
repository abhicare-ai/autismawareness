      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col-reverse gap-5 md:flex-row">
          ...
          <div className="space-y-6 px-3 md:basis-3/2">
            ...
            <h2 className="text-xl font-bold">Signs of autism in babies</h2>

            <h3 className="font-semibold">By 6 months</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>Few or no big smiles or other warm, joyful, and engaging expressions</li>
              <li>Limited or no eye contact</li>
            </ul>

            <h3 className="font-semibold">By 9 months</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>Little or no back-and-forth sharing of sounds, smiles, or other facial expressions</li>
            </ul>

            <h2 className="text-xl font-bold">Signs of autism in toddlers</h2>

            <h3 className="font-semibold">By 12 months</h3>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h3 className="font-semibold">By 16 months</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>Very few or no words</li>
            </ul>

            <h3 className="font-semibold">By 24 months</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>Very few or no meaningful, two-word phrases (not including imitating or repeating)</li>
            </ul>

            <h2 className="text-xl font-bold">Signs of autism at any age</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="text-xl font-bold">At what age is autism diagnosed?</h2>
            <p>
              Signs of autism and early signs can vary widely from child to child. Some children show early signs of autism within their first 12 months of life. In others, autism signs may show up around 18-24 months of age. Some children with ASD gain new skills and then lose them, showing regression between 18-24 months of age. Diagnosis by an experienced professional can be considered reliable by age 2.
            </p>

            <p>
              The American Academy of Pediatrics (AAP) recommends that all children be screened for autism at ages 18 months and 24 months, in addition to regular developmental checkups at 9 months, 18 months, and 30 months.
            </p>
