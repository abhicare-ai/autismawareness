        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col-reverse gap-5 md:flex-row">
            ...
            <div className="space-y-3 px-3 md:basis-3/2">
              <Heading>Autism and mental health</Heading>

              <Paragraph>
                Most autistic people experience a co-occurring mental health
                condition. Specifically, the Diagnostic and Statistical Manual
                of Mental Illnesses, or DSM-5 notes: About 70% of individuals
                with autism spectrum disorder (ASD) may have one co-occurring
                mental disorder, and 40% may have two or more. According to a
                2020 CDC report, 26% of the general population experience a
                mental health condition, and the National Institute of Mental
                Health (NIMH) reports 1 in 5 adults experience mental illness
                each year.
              </Paragraph>
              ...
              <Paragraph>
                ...
                not designed to address the unique mental and general health
                needs of autistic individuals. This leads to a lack of provider
                support, high rates of misdiagnosis and missed diagnosis,
                untreated related medical conditions and increased barriers to
                appropriate care.
              </Paragraph>

              <Paragraph>
                In short, navigating a world which was not designed, welcoming
                or understanding of their needs can put autistic people at risk
                for mental health conditions and exacerbate existing symptoms.
              </Paragraph>
              ...
              <ListTag>
                <li>
                  ...
                  Act, the primary source of federal funding for autism.
                  Included is a $100 million Autism Center for Excellence
                  program to accelerate the research into supporting the
                  intersection of autism and mental health for autistic adults,
                  among other related needs.
                </li>
                <li>
              ...
              <Paragraph>
                ...
                community. Team members are Certified Resource Specialists
                through Inform USA and are specially trained to provide
                personalized information and resources—including those related
                to mental health—to autistic individuals, families, service
              ...
              <Paragraph>
                ...
                cities/towns, is for those aligned with Autism Speaks in
                creating a more inclusive and accepting community with autistic
                people. Developed with self-advocates and subject matter
                experts, the training teaches allies how to create
                autism-friendly spaces, and how to build community connections
              ...
              <Paragraph>
                ...
                workers. One component of WIN is online training courses
                designed to raise awareness around neurodiversity and provide
                strategies among those who hire autistic and related conditions
                in order to reduce bias and increase understanding.
              </Paragraph>

              <Heading>Related resources on autism and mental health</Heading>
              <ListTag>
                <li>Mental health resources for people with autism</li>
                <li>
                  Common co-occurring mental health conditions with autism
                </li>
