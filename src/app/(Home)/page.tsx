          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-5 px-3 md:flex-row">
            ...
            <div className="text-card space-y-5 py-8 md:w-1/2">
              ...
              <p>
                ...
                difference in the autism community. Whether you choose to walk
                or run, participate as an individual or as part of a team — join
            ...
            <div className="space-y-10">
              <div className="flex flex-col gap-5 md:flex-row">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Autism Speaks CSO Andy Shih reflects on the Hill Day event
                    and highlights the urgent need to close persistent gaps in
