    ...
    <div className="bg-primary text-card w-full rounded-2xl border shadow-md">
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        <div>
          ...
          <p className="text-card text-sm">{time} Rahul</p>
        </div>
      </div>

      {/* Star Ratings */}
      <div className="mt-2 flex gap-1 p-3">
      ...
      />
      {/* Review Text */}
      <p className="text-card mt-3 p-3 text-sm leading-relaxed">
...
const reviews = [
  {
    name: "Rahul Sharma",
    time: "2 days",
    profilePic: "/autism-friendly.png.webp",
    stars: 5,
